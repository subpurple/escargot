...
BUCP and FLAP-level authentication has been fully implemented. Next on the list is to implement feedbag (buddy list), implement buddy notifications, and finally implement IMs.
