...
class BackendEventHandler(metaclass = ABCMeta):
	...
	@abstractmethod
	def on_presence_notification(self, bs_other: Optional['BackendSession'], ctc: Contact, on_contact_add: bool, *, trid: Optional[str] = None, update_status: bool = True, send_status_on_bl: bool = False, sess_id: Optional[int] = None, updated_phone_info: Optional[Dict[str, Any]] = None) -> None: pass
