...
class User:
    ...
    def __init__(
            ...
            settings: Dict[str, Any], date_created: datetime, date_login: datetime
    ) -> None:
        self.id = id
        self.uuid = uuid
        self.email = email
...
class Contact:
    ...
    def __init__(
            self, user: User, groups: Set['ContactGroupEntry'], lists: 'Lst', status: 'UserStatus',
            detail: 'ContactDetail', *,
...
class ContactDetail:
    ...
    def __init__(
            ...
            other_phone: Optional[str] = None, personal_website: Optional[str] = None,
...
class MessageData:
    ...
    def __init__(self, *, sender: User, sender_pop_id: Optional[str] = None, type: MessageType,
...
class RoamingInfo:
    ...
    def __init__(self, name: Optional[str], name_last_modified: datetime, message: Optional[str],
                 message_last_modified: datetime) -> None:
        self.name = name
...
class GroupChatMembership:
    __slots__ = (
        'chat_id', 'head', 'role', 'state', 'blocking', 'inviter_uuid', 'inviter_email', 'inviter_name',
        'invite_message',
    )
...
class OIM:
    __slots__ = (
        'uuid', 'run_id', 'from_email', 'from_username', 'from_friendly', 'from_friendly_encoding',
    ...
    def __init__(
            self, uuid: str, run_id: str, from_email: str, from_username: str, from_friendly: str, to_email: str,
            sent: datetime,
            message: str, utf8: bool, *, headers: Optional[Dict[str, str]] = None,
            from_friendly_encoding: Optional[str] = None,
            from_friendly_charset: Optional[str] = None, from_user_id: Optional[str] = None,
